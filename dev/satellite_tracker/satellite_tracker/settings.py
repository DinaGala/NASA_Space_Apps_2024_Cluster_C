...
SECRET_KEY = 'django-insecure-m!$!_2kvme&2k#(v$7*tss=3l(!cj6pss3vn8ab_haqukv)r48'
...
EMAIL_HOST_PASSWORD = 'landset12345'


# myproject/settings.py
CELERY_BROKER_URL = 'redis://localhost:6379/0'  # Используй Redis как брокер
