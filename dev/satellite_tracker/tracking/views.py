...
key_file_path = os.path.join(settings.BASE_DIR, 'data', 'ee-dinazhuzhleva-3f9d85c2587b.json')
credentials = ee.ServiceAccountCredentials('nasa2024@ee-dinazhuzhleva.iam.gserviceaccount.com', key_file_path)
# Аутентификация
#ee.Authenticate()
